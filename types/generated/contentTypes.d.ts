...
export interface ApiFinancialHighlightFinancialHighlight
  ...
  attributes: {
    breakupValueOfShares: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date: Schema.Attribute.Date;
    dividendPayoutRatio: Schema.Attribute.String;
    eps: Schema.Attribute.String;
    freeFloatOfShares: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    peRatio: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPharmaceuticalAreaPharmaceuticalArea
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    pharma_image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
...
export interface ApiSafetyReportSafetyReport
  extends Struct.CollectionTypeSchema {
  collectionName: 'safety_reports';
  info: {
    displayName: 'Safety Reports';
    pluralName: 'safety-reports';
    singularName: 'safety-report';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    adverseEventDetails: Schema.Attribute.Text;
    causeOfEvent: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dosageForm: Schema.Attribute.String;
    drugEndDate: Schema.Attribute.Date;
    drugIndication: Schema.Attribute.String;
    drugName: Schema.Attribute.String;
    drugStartDate: Schema.Attribute.Date;
    eventEndDate: Schema.Attribute.Date;
    eventStartDate: Schema.Attribute.Date;
    isDrugOngoing: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    managementOfEvents: Schema.Attribute.Text;
    ...
    >;
    patientAge: Schema.Attribute.String;
    patientGender: Schema.Attribute.Enumeration<['Male', 'Female']>;
    patientInitials: Schema.Attribute.String;
    pregnancyExposureEndDate: Schema.Attribute.Date;
    pregnancyExposureStartDate: Schema.Attribute.Date;
    publishedAt: Schema.Attribute.DateTime;
    reporterEmail: Schema.Attribute.Email;
    reporterName: Schema.Attribute.String;
    reporterProfession: Schema.Attribute.String;
    reporterTelephone: Schema.Attribute.String;
    seriousnessCriteria: Schema.Attribute.Enumeration<
      [
        'Life threatening',
    ...
    >;
    seriousnessDate: Schema.Attribute.Date;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiWebsiteUpdateDateWebsiteUpdateDate
  extends Struct.SingleTypeSchema {
  collectionName: 'website_update_dates';
  info: {
    displayName: 'WebsiteUpdateDate';
    pluralName: 'website-update-dates';
    singularName: 'website-update-date';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::website-update-date.website-update-date'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::safety-report.safety-report': ApiSafetyReportSafetyReport;
      'api::website-update-date.website-update-date': ApiWebsiteUpdateDateWebsiteUpdateDate;
